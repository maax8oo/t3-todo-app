  ...
  return (
    <div className="flex items-center justify-between rounded-md border-2 border-gray-one px-5 py-4">
      <div className="flex w-full max-w-lg items-center justify-start">
        <input
          className="h-4 w-4 rounded border border-green-three bg-cream-four text-green-four focus:outline focus:outline-2 focus:outline-offset-2 focus:outline-green-five"
          type="checkbox"
          name="done"
          id="{id}"
          checked={isCompleted}
        ...
        />
        <input
          className="ML-5 flex-1 text-ellipsis rounded-none border-x-0 border-b border-t-0 border-dashed border-b-gray-two bg-cream-four px-0 pb-1 text-base font-normal text-gray-three placeholder:text-green-two focus:border-gray-three focus:outline-none focus:ring-0"
          id={`${todo.id}-text`}
          type="text"
      ...
      >
        <svg
          className="h-5 w-5 text-steel-three group-hover:text-green-five"
          width="32"
          height="32"
          viewBox="none"
          fill="none"
